...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    title: 'コーデをシェアしよう',
    subtitle: '毎日のコーデを残して\nフォロワーと感性をつなごう',
    body: '診断で自分の系統を知り、同じ感性の人と繋がり、コーデを記録したり、着こなしのヒントが見つかる場所。',
  },
  {
    id: 'cosmo',
    title: 'COSMO',
  ...
  },
  {
    ...
    body: '毎日更新されるデイリーチャレンジ。テーマに合わせたコーデを残して、あなたのセンスを発揮しよう。',
  },
  {
    id: 'styleid',
    title: 'STYLE ID',
  ...
  },
  {
    ...
    body: '記録したコーデをAIが分析し、スタイルアップのアドバイスをくれる。センスの磨き方をAIと一緒に探そう。',
  },
]
