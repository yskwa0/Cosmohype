                ...
                <>
                  {currentImage > 0 && (
                    <button onClick={e => { e.stopPropagation(); setCurrentImage(i => i - 1) }}
                      className="absolute left-2 top-1/2 -translate-y-1/2 w-7 h-7 rounded-full bg-black/35 backdrop-blur-sm flex items-center justify-center">
                  ...
                  {currentImage < images.length - 1 && (
                    <button onClick={e => { e.stopPropagation(); setCurrentImage(i => i + 1) }}
                      className="absolute right-2 top-1/2 -translate-y-1/2 w-7 h-7 rounded-full bg-black/35 backdrop-blur-sm flex items-center justify-center">
                      <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor" strokeWidth={2.5}>
