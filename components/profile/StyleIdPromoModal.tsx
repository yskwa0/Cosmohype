  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ height: 3, background: 'linear-gradient(90deg, transparent, #7C3AED, #A855F7, transparent)' }} />
        ...
        <div className="px-6 pt-6 pb-7">
          ...
          >
            <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none" stroke="#A855F7" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round">
          ...
          <h2 className="text-base font-bold mb-2" style={{ color: '#EDE9FE' }}>
            まだSTYLE IDが設定されていません
          </h2>

          {/* Body */}
          <p className="text-sm leading-relaxed mb-5" style={{ color: 'rgba(196,181,253,0.8)' }}>
            STYLE ID診断をすると、自分に近いファッション系統がわかります。
            <br /><br />
            診断後は、COSMOで感性や雰囲気が近い人のスタイルを見ることができ、コーデの参考にもなります。まずはあなたのスタイルを見つけてみませんか？
          </p>
